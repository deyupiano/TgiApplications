...
namespace TgiApplications
{
    ...
    public class SmsService : IIdentityMessageService
    {
        public Task SendAsync(IdentityMessage message)
        {
            ...
            request.CookieContainer = cookies;
            string data = spc.Data(mSender: "TOLBEEL GLOBAL INVESTMENT", gsm: message.Destination, smsText: message.Body);
    ...
    public class ApplicationUserManager : UserManager<ApplicationUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<ApplicationUser>(context.Get<TgiDbContext>()));
